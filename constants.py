...
ROOT_PATH = './data'
CA_PATH = './data/etc/CA'
SECRETS_PATH = './data/etc/secrets'
LOCALE_PATH = './data/var/locale'
FILEOBJECT_PATH = './data/var/objects'
PUBLIC_PATH = './data/var/public'
STATIC_PATH = './data/var/public/static'
TEMPLATE_PATH = './data/var/template'
